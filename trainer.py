...
def _train(args):
    ...
    logfilename = "logs/{}/{}/{}/{}/seed:{}_model:{}__fttepoch:{}_rffD:{}".format(args["model_name"], args["dataset"], 
        init_cls, args["increment"], args["seed"], args["model_name"], args["tuned_epoch"], args["rff_d"])
